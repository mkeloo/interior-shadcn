      ...
      <div className="container lg:grid lg:grid-cols-2 py-14">
        ...
        >
          ...
          <div className="relative lg:max-w-sm">
            ...
            <button className="absolute bg-black text-white font-bold rounded-full h-10 px-3 text-sm top-2 right-2 hover:border-2 hover:border-black hover:bg-white hover:text-black dark:bg-primary transition-all duration-200">
              Subscribe
            </button>
          </div>
